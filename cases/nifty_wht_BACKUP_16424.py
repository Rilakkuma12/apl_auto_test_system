...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(1000000):
            ...
            # 上料
            kafka_load_consumables.load_consumable_all_board(us.b_SP96XL4, is_pro_area=False, load={'MGRK01': ('POS3', 'POS2'), 'MGRK02': ('POS12', 'POS20')})
            # # 运行脚本
            kafka_run_script.run_script(us.b_SP96XL4, 'spx96_pre_clean_cn_local_new.py')

            # 转移
            # kafka_transfer.transfer(us.a_SP96XL1, 'POS2', us.a_SP96XL2, 'POS17')

            # 下料
            kafka_push_consumables.push_consumable_all_boards(us.b_SP96XL4, is_pro_area=False, push={'MGRK01': ('POS3', 'POS2'), 'MGRK02': ('POS12', 'POS20')})
