...
if __name__ == '__main__':
    ...
    try:
        ...
        for i in range(1):
            ...
            # 上料
            kafka_load_consumables.load_consumable_all_board(us.b_SP96XL4, load={'MGRK01': ('POS3', 'POS2'), 'MGRK02': ('POS12', 'POS20')})
            # # 运行脚本
            ...
            #
            # # 下料
            # kafka_push_consumables.push_from_pn(us.a_SP96XL1, push={'MGRK01': 'POS2', 'MGRK02': ('POS12', 'POS20')})
            #
