...
def transfer_resp(task_id, comm_id, req_id, clear_type_num, barcode, idx):
    comm = '''{
        "message_id": "UUID",
...
def handle_task_err():
    while True:
        task_id, comm_id, req_id, barcode, idx = us.get_robot_request_exception_info()
    ...
    msg = transfer_resp(task_id, comm_id, req_id, num, barcode, idx)
